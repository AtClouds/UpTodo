...
export function  footerRender({ isProfile = false } = {}) {
      ...
      <!------Calender----->
            <img src="/images/03-index-screen-home/calendar.png" id="calenderBtn" class="w-auto hover:scale-150 transition-all ease-in-out duration-300 cursor-pointer" alt="">
      <!------Add Icon----->
        ...
        <!------Focus----->
            <img src="/images/03-index-screen-home/clock.png" id="focusBtn" class="w-auto hover:scale-150 transition-all ease-in-out duration-300 cursor-pointer" alt="">
        <!------User----->
