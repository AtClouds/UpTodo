...
function renderIntroPage() {
    renderIntroHTML += `
        ...
        <!------SlideShow One------->
            ...
            <!-----Image---->
            <div>
            <img src="/images/01-Intro/Group 182.png" class="min-w-20 mt-20" alt="slide /i/images">
            </div>
        ...
        <!------SlideShow Two------->
            ...
            <!-----Image---->
            <div>
            <img src="/images/01-Intro/Frame 162.png" class="min-w-20 mt-20" alt="slide /i/images">
                </div>
        ...
        <!------SlideShow Three------->
            ...
            <!-----Image---->
            <div>
            <img src="/images/01-Intro/Frame 161.png" class="min-w-20 mt-20" alt="slide /i/images">
                </div>
